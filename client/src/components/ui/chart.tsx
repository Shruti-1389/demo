...
const BarChart: React.FC<{
  ...
  height?: number;
  color?: string;
}> = ({ data, xField, yField, height = 300, color = "#0066CC" }) => {
  return (
    <RechartsPrimitive.ResponsiveContainer width="100%" height={height}>
      <RechartsPrimitive.BarChart data={data} margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
        ...
        <RechartsPrimitive.Bar dataKey={yField} fill={color} radius={[4, 4, 0, 0]} />
...
const PieChart: React.FC<{
  ...
  valueAccessor?: (entry: PieArcDatum<any>) => number;
  labelAccessor?: (entry: PieArcDatum<any>) => string;
  colors?: string[];
}> = ({ 
  data, 
  width = 400, 
  ...
  labelAccessor = (entry) => entry.data?.name,
  colors = ["#0066CC", "#2C3E50", "#28A745", "#FFC107", "#DC3545"]
}) => {
  ...
  return (
    <RechartsPrimitive.ResponsiveContainer width="100%" height={height}>
      <RechartsPrimitive.PieChart width={width} height={height} margin={margin}>
